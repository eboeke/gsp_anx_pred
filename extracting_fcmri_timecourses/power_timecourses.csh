...
set mask_path = ../masks/power_masks
set MNImaskdir = /scratch/eb1384/gsp/ROIs/PowerROIs
...
if (! -e  ../power_timecourses) then
mkdir ../power_timecourses
endif

foreach roiIdx (`seq 1 270`)
set mask = Power${roiIdx}
    ...
    #extract timeseries
    fslmeants -i nuisance.feat/stats/res4d.nii.gz -o ../power_timecourses/${mask}.txt -m ${mask_path}/${mask}.nii.gz
